...
Struct containing two n*n arrays representing the ellipse approximation of the loglikelihood function around the MLE point. See [`getMLE_ellipse_approximation!`](@ref)
...
"""
    CoreLikelihoodModel(loglikefunction::Function, predictfunction::Union{Function,Missing}, 
...
"""
    LikelihoodModel(core::CoreLikelihoodModel, ellipse_MLE_approx::Union{Missing,EllipseMLEApprox},
