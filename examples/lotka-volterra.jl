...
display(plt)
savefig(plt, joinpath("docs", "src", "assets", "figures", "lotka-volterra", "lotka-volterra_univariate_plots.png"))

plts = plot_bivariate_profiles(model, confidence_levels=[0.95], dofs=[model.core.num_pars])
plt = plot(plts..., layout=(2,3),
    legend=:outertop, title="", dpi=150, size=(550,300), margin=1mm)
display(plt)
savefig(plt, joinpath("docs", "src", "assets", "figures", "lotka-volterra", "lotka-volterra_bivariate_plots.png"))
...
# savefig(plt, joinpath("docs", "src", "assets", "figures", "lotka-volterra", "lotka-volterra_univariate_trajectory.png"))
...
plot!(plt[2], t_pred, model_trajectory[2],
    label="True model trajectory", lw=3, color=:turquoise4, linestyle=:dash)
# savefig(plt, joinpath("docs", "src", "assets", "figures", "lotka-volterra", "lotka-volterra_bivariate_trajectory.png"))
...
# savefig(plt, joinpath("docs", "src", "assets", "figures", "lotka-volterra", "lotka-volterra_univariate_reference_tolerance.png"))
...
scatter!(plt, data.t, data.y_obs, label="Observations", msw=0, ms=7, color=palette(:Paired)[3],
    xlims=(t_pred[1], t_pred[end]), dpi=150, size=(450, 300))
# savefig(plt, joinpath("docs", "src", "assets", "figures", "lotka-volterra", "lotka-volterra_bivariate_reference_tolerance.png"))
